  ...
  return (
    <>
      <button
        ...
        className="px-6 w-auto min-w-44 py-2   hover:shadow-lg text-black max-w-40 flex justify-center align-center text-center text-md rounded-xl drop-shadow-lg"
      >
