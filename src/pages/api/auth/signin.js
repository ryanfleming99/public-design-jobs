  ...
  return (
    <>
      <button
        ...
        className="px-6 w-auto min-w-44 py-2 bg-white border border-gray-400 shadow-md hover:shadow-lg text-black w-full max-w-40 flex justify-center align-center text-center text-md  rounded-lg"
      >
